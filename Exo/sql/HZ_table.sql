...
Create table if not exists HZ_table as Select Inside.pl_hostname as Star, Inside.pl_name as Planet, Inside.st_spstr as Type, Inside.inside as inside, Outside.outside as outside from Inside
inner join Outside 
