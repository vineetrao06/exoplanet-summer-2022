...
v1.1: Modified by Alexander Lau on Fri Jul 29 23:11 2022
Purpose: Very minor bug fix; not of great importance. We eliminate entries with controversial
flags BEFORE deduplicating. I'll test it on the exoplanet dataset to see if there are any changes
with deduplication.
